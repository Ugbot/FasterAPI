...
class MCPBindings:
    ...
    def __init__(self):
        if _lib is None:
            raise RuntimeError("MCP native library not loaded. Run 'make build' to compile.")
    ...
    def server_register_tool(self, handle, name: str, description: str, input_schema: str, handler_id: int):
    ...
    def server_register_resource(self, handle, uri: str, name: str, description: str, mime_type: str, provider_id: int):
