...
def _error_from_code(code: int, message: str) -> Exception:
    ...
    from .exceptions import (
        PgError, PgConnectionError, PgTimeout, PgCanceled,
        PgIntegrityError, PgDataError
    )
...
def declare_functions() -> None:
    ...
    lib.pg_pool_create.argtypes = [ctypes.c_char_p, ctypes.c_uint, ctypes.c_uint, ctypes.POINTER(ctypes.c_int)]
    ...
    lib.pg_pool_get.argtypes = [PgPoolHandle, ctypes.c_uint, ctypes.c_uint64, ctypes.POINTER(ctypes.c_int)]
    ...
    lib.pg_exec_query.argtypes = [PgConnectionHandle, ctypes.c_char_p, ctypes.c_uint, ctypes.POINTER(ctypes.c_char_p), ctypes.POINTER(ctypes.c_int)]
    ...
    lib.pg_tx_begin.argtypes = [PgConnectionHandle, ctypes.c_char_p, ctypes.POINTER(ctypes.c_int)]
    ...
    lib.pg_copy_in_start.argtypes = [PgConnectionHandle, ctypes.c_char_p, ctypes.POINTER(ctypes.c_int)]
    ...
    lib.pg_copy_in_write.argtypes = [PgConnectionHandle, ctypes.c_char_p, ctypes.c_uint64, ctypes.POINTER(ctypes.c_int)]
